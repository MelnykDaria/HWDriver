...
public class TestNGDemo {
    ...
    private By appendInputsLocator = By.xpath("//label[text()='Append a text and press keyboard tab']/following-sibling::input");
    private By getTextInputsLocator = By.xpath("//label[text()='Get default text entered']/following-sibling::input");
    private By clearTextLocator = By.xpath("//label[text()='Clear text']/following-sibling::input");
    ...
    public void setUp() {
        ...
        appendInput = driver.findElement(appendInputsLocator);
        getTextInput = driver.findElement(getTextInputsLocator);
